...
##
# revisions
extdataDir<-system.file("extdata/", package="meaRtools")
analysis$Robject[1]<-paste0(dirname(analysis$Routput_dir), "/", "basicSobject.RData")
...
add_plateinfo("test_platelayout", test_platelayout)
...
s = read_spikelist_text(times, pos, array="test_platelayout",div=3)
save(s, file=paste0(analysis$Robject[1]))
