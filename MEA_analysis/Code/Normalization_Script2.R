...
cat("arg[6]s= "); cat(args[6]); cat("\n")
cat("arg[7]s= "); cat(args[7]); cat("\n")

in.dir=args[6]
out.dir=args[7]
cat("in.dir= ");cat(in.dir);cat("\n")
cat("out.dir= ");cat(out.dir); cat("\n")


all.args<-paste( args[8:length(args)], collapse=" ")
#cat("all.args= "); cat(all.args); cat("\n")

treatments<-strsplit(all.args, "*", fixed=T)[[1]][2]
feature_name<-strsplit(all.args, "@", fixed=T)[[1]][2]
norm.method<-strsplit(all.args, "^", fixed=T)[[1]][2]


cat("treatments= ");cat(paste0("'",treatments,"'"));cat("\n")
cat("feature_name= ");cat(paste0("'",feature_name,"'"));cat("\n");
cat("norm.method= ");cat(norm.method); cat("\n")
...
# treatments = c("WT", "HOM") 
# in.dir="/Users/dh2744/Dropbox/Columbia/Software/normalization_Chris/test_folder_normalization"
# out.dir="/Users/dh2744/Dropbox/Columbia/Software/normalization_Chris/test_folder_normalization"
# norm.method="ALL_WT" ; treatments = "WT" ;feature_name = "Mean Dur"
df = Analyze(in.dir=in.dir,
             out.dir=out.dir,
